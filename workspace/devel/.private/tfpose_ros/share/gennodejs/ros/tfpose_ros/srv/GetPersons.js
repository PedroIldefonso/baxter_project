...
let Persons = require('../msg/Persons.js');
...
class GetPersonsRequest {
  ...
  static datatype() {
    ...
    return 'tfpose_ros/GetPersonsRequest';
  }
...
class GetPersonsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Persons.serialize(obj.persons, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.persons = Persons.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Persons.getMessageSize(object.persons);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.persons !== undefined) {
      resolved.persons = Persons.Resolve(msg.persons)
    }
    else {
      resolved.persons = new Persons()
    }
...
module.exports = {
  ...
  md5sum() { return 'eac1ac7f48af0b16a14c17b14c3bebc0'; },
  datatype() { return 'tfpose_ros/GetPersons'; }
};
