...
(cl:defmethod cl:initialize-instance :after ((m <GetPersons-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPersons-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tfpose_ros-srv:<GetPersons-request> is deprecated: use tfpose_ros-srv:GetPersons-request instead.")))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <GetPersons-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfpose_ros-srv:image-val is deprecated.  Use tfpose_ros-srv:image instead.")
  (image m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetPersons-request>)))
  ...
  "eac1ac7f48af0b16a14c17b14c3bebc0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetPersons-request)))
  "Returns md5sum for a message object of type 'GetPersons-request"
  "eac1ac7f48af0b16a14c17b14c3bebc0")
...
(cl:defclass <GetPersons-response> (roslisp-msg-protocol:ros-message)
  ((persons
    :reader persons
    :initarg :persons
    :type tfpose_ros-msg:Persons
    :initform (cl:make-instance 'tfpose_ros-msg:Persons)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetPersons-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPersons-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tfpose_ros-srv:<GetPersons-response> is deprecated: use tfpose_ros-srv:GetPersons-response instead.")))

(cl:ensure-generic-function 'persons-val :lambda-list '(m))
(cl:defmethod persons-val ((m <GetPersons-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tfpose_ros-srv:persons-val is deprecated.  Use tfpose_ros-srv:persons instead.")
  (persons m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetPersons-response>)))
  ...
  (cl:format cl:nil "Persons persons~%~%================================================================================~%MSG: tfpose_ros/Persons~%Person[] persons~%uint32 image_w~%uint32 image_h~%Header header~%================================================================================~%MSG: tfpose_ros/Person~%BodyPartElm[] body_part~%uint32 person_id~%================================================================================~%MSG: tfpose_ros/BodyPartElm~%uint32 part_id~%float32 x~%float32 y~%float32 confidence~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetPersons-response)))
  "Returns full string definition for message of type 'GetPersons-response"
  (cl:format cl:nil "Persons persons~%~%================================================================================~%MSG: tfpose_ros/Persons~%Person[] persons~%uint32 image_w~%uint32 image_h~%Header header~%================================================================================~%MSG: tfpose_ros/Person~%BodyPartElm[] body_part~%uint32 person_id~%================================================================================~%MSG: tfpose_ros/BodyPartElm~%uint32 part_id~%float32 x~%float32 y~%float32 confidence~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
