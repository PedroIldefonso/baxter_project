...
(defsystem "tfpose_ros-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "BodyPartElm3D" :depends-on ("_package_BodyPartElm3D"))
    (:file "_package_BodyPartElm3D" :depends-on ("_package"))
    (:file "Person" :depends-on ("_package_Person"))
    (:file "_package_Person" :depends-on ("_package"))
    (:file "Person3D" :depends-on ("_package_Person3D"))
    (:file "_package_Person3D" :depends-on ("_package"))
    (:file "Persons" :depends-on ("_package_Persons"))
    (:file "_package_Persons" :depends-on ("_package"))
    (:file "Persons3D" :depends-on ("_package_Persons3D"))
    (:file "_package_Persons3D" :depends-on ("_package"))
  ))