...
"""autogenerated by genpy from tfpose_ros/GetPersonsRequest.msg. Do not edit."""
import sys
...
class GetPersonsRequest(genpy.Message):
  ...
  _type = "tfpose_ros/GetPersonsRequest"
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from tfpose_ros/GetPersonsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetPersonsResponse(genpy.Message):
  _md5sum = "203abe0ab4f79d69cd66aee40fe396ce"
  _type = "tfpose_ros/GetPersonsResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """Persons persons
...
"""
  __slots__ = ['persons']
  _slot_types = ['tfpose_ros/Persons']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.persons is None:
        self.persons = tfpose_ros.msg.Persons()
    else:
      self.persons = tfpose_ros.msg.Persons()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.persons.persons)
      buff.write(_struct_I.pack(length))
      for val1 in self.persons.persons:
      ...
      _x = self
      buff.write(_get_struct_5I().pack(_x.persons.image_w, _x.persons.image_h, _x.persons.header.seq, _x.persons.header.stamp.secs, _x.persons.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.persons.persons.append(val1)
      _x = self
      start = end
      end += 20
      (_x.persons.image_w, _x.persons.image_h, _x.persons.header.seq, _x.persons.header.stamp.secs, _x.persons.header.stamp.nsecs,) = _get_struct_5I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.persons.header.frame_id = str[start:end].decode('utf-8')
      else:
...
class GetPersons(object):
  _type          = 'tfpose_ros/GetPersons'
  _md5sum = 'eac1ac7f48af0b16a14c17b14c3bebc0'
